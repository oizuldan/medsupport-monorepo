...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"16":"0370df1baf8240dcaa2b","19":"6553fe02ef761d121a89"}[chunkId] + ".js");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ LoginPage; });
...
// CONCATENATED MODULE: ./src/components/pages/LoginPage/component.tsx
var __jsx = external_react_default.a.createElement;
...
const Header = dynamic_default()(() => __webpack_require__.e(/* import() */ 19).then(__webpack_require__.bind(null, "6+hv")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("6+hv")],
    modules: ['./libs/Header']
  }
});
...
const LoginPage = () => {
  ...
  const onGoBack = Object(external_react_["useCallback"])(() => router.push('/'), [router]);
  ...
  const onLogIn = Object(external_react_["useCallback"])(async () => {
    setLoading(true);

    try {
      const res = await external_axios_default.a.post('http://localhost:3000/proxy/auth/login', {
        username,
        password
      });
    ...
    setLoading(false);
  }, [username, password, callToastAndRefresh, router]); // const onGoToSignUp = useCallback(() => router.push('/signup'), [router]);
  ...
  }, "\u0412\u0445\u043E\u0434 \u0432 \u0430\u043A\u043A\u0430\u0443\u043D\u0442"), Object(core_["jsx"])("div", {
...
// CONCATENATED MODULE: ./src/components/pages/LoginPage/index.ts
