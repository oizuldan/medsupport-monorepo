...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"16":"3405e255aace74581f21","19":"575e74bdade1d6878db3"}[chunkId] + ".js");
...
const LoginPage = () => {
  ...
  const onLogIn = Object(external_react_["useCallback"])(async () => {
    ...
    try {
      const res = await external_axios_default.a.post(`https://medsupport.dev/api/auth/login`, {
        username,
        password
      });
