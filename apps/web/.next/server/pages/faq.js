...
module.exports = __webpack_require__("YN3z");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ FaqPage; });
...
// CONCATENATED MODULE: ./src/components/pages/FaqPage/graphql.ts

const queryFaqPage = client_["gql"]`
...
// CONCATENATED MODULE: ./src/components/pages/FaqPage/libs/Questions/component.tsx
var __jsx = external_react_default.a.createElement;
...
// CONCATENATED MODULE: ./src/components/pages/FaqPage/libs/Questions/index.ts

// CONCATENATED MODULE: ./src/components/pages/FaqPage/libs/RelevantTopics/component.tsx
var component_jsx = external_react_default.a.createElement;
...
// CONCATENATED MODULE: ./src/components/pages/FaqPage/libs/RelevantTopics/index.ts

// CONCATENATED MODULE: ./src/components/pages/FaqPage/libs/VaccineBanner/component.tsx

var VaccineBanner_component_jsx = external_react_default.a.createElement;
...
// CONCATENATED MODULE: ./src/components/pages/FaqPage/libs/VaccineBanner/index.ts

// CONCATENATED MODULE: ./src/components/pages/FaqPage/component.tsx
var FaqPage_component_jsx = external_react_default.a.createElement;
...
const FaqPage = props => {
  ...
  const questions = Object(external_react_["useMemo"])(() => {
    ...
    return Object(pipeable_["pipe"])(Option_["fromNullable"](data === null || data === void 0 ? void 0 : (_data$data = data.data) === null || _data$data === void 0 ? void 0 : (_data$data$faq = _data$data.faq) === null || _data$data$faq === void 0 ? void 0 : (_data$data$faq$actual = _data$data$faq.actualTopics) === null || _data$data$faq$actual === void 0 ? void 0 : _data$data$faq$actual.questions), Option_["chain"](Option_["fromPredicate"](v => Array.isArray(v))), Option_["chain"](qs => Object(Array_["sequence"])(Option_["option"])(qs.map(q => Object(pipeable_["pipe"])(Option_["fromNullable"](q))))), Option_["getOrElseW"](() => []));
  }, [data === null || data === void 0 ? void 0 : (_data$data2 = data.data) === null || _data$data2 === void 0 ? void 0 : (_data$data2$faq = _data$data2.faq) === null || _data$data2$faq === void 0 ? void 0 : (_data$data2$faq$actua = _data$data2$faq.actualTopics) === null || _data$data2$faq$actua === void 0 ? void 0 : _data$data2$faq$actua.questions]);
  const questionCategories = Object(external_react_["useMemo"])(() => {
    var _data$data3;
...
// CONCATENATED MODULE: ./src/components/pages/FaqPage/index.ts

// CONCATENATED MODULE: ./src/pages/faq.ts
