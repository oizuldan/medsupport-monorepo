...
const QuestionsPage = props => {
  var _data$data2, _data$data4, _data$data5, _data$data6, _data$data7, _data$data8, _data$data8$allQuesti, _data$data9, _data$data9$allQuesti;
  ...
  return Object(core_["jsx"])(components["C" /* Layout */], {
    ...
    className: "tw-flex tw-flex-col md:tw-flex-row tw-mb-8"
