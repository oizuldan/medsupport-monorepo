...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"16":"0370df1baf8240dcaa2b","21":"2c714f06db8e1dfc49ed"}[chunkId] + ".js");
...
module.exports = __webpack_require__("m5q3");
...
__webpack_require__.d(__webpack_exports__, "l", function() { return /* reexport */ Divider; });
...
__webpack_require__.d(__webpack_exports__, "j", function() { return /* reexport */ Interactive; });
__webpack_require__.d(__webpack_exports__, "k", function() { return /* reexport */ Carousel; });
...
__webpack_require__.d(__webpack_exports__, "n", function() { return /* reexport */ Directions_Directions; });
__webpack_require__.d(__webpack_exports__, "m", function() { return /* reexport */ Drawer; });
__webpack_require__.d(__webpack_exports__, "A", function() { return /* reexport */ component_Label; });
__webpack_require__.d(__webpack_exports__, "F", function() { return /* reexport */ Markdown; });
...
__webpack_require__.d(__webpack_exports__, "D", function() { return /* reexport */ component_Item; });
__webpack_require__.d(__webpack_exports__, "E", function() { return /* reexport */ ItemButton; });
__webpack_require__.d(__webpack_exports__, "C", function() { return /* reexport */ List; });
__webpack_require__.d(__webpack_exports__, "p", function() { return /* reexport */ Footer; });

// UNUSED EXPORTS: DividerDirections, H1Regular, CardTitle, CardContent, BasicCarousel, Table, PaginationItemTypes, popoverModifiers, PopoverTargetTypes, PopoverModifierNames, PopoverCoverStrategies
...
const ItemButtonBase = /*#__PURE__*/Object(external_react_["forwardRef"])((_ref, ref) => {
  ...
  return Object(core_["jsx"])(Component, ItemButton_component_extends({
    ...
    color: core["a" /* colors */].variants.Text.Primary,
    typography: core["e" /* typography */].variants.Heading.Regular22,
    className: external_classnames_default()('w-100', 'px-3', 'justify-content-between', className) // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
const Footer = (_ref) => {
  ...
  return Object(core_["jsx"])("div", Footer_component_extends({
    ...
    className: "container-xl d-flex flex-lg-row flex-column w-100 align-items-center"
  }, Object(core_["jsx"])("img", {
    alt: "footer",
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ SignUpPage; });
...
// CONCATENATED MODULE: ./src/components/pages/SignUpPage/component.tsx
var __jsx = external_react_default.a.createElement;
...
const Header = dynamic_default()(() => __webpack_require__.e(/* import() */ 21).then(__webpack_require__.bind(null, "CniG")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("CniG")],
    modules: ['./libs/Header']
  }
});
...
const SignUpPage = () => {
  ...
  const {
    0: showRepeatPassword,
    1: setShowRepeatPassword
  } = Object(external_react_["useState"])(false);
  const {
    0: loading,
    1: setLoading
  } = Object(external_react_["useState"])(false);
  const buttonDisabled = username.length === 0 || email.length === 0 || password.length === 0 || repeatPassword.length === 0 || firstName.length === 0 || lastName.length === 0;
  const validateEmail = Object(external_react_["useCallback"])(value => REGEX_FOR_EMAIL.test(value), []);
  const validateInputs = Object(external_react_["useCallback"])(() => {
  ...
  const onChangeEmail = Object(external_react_["useCallback"])(event => setEmail(event.target.value), []);
  const onChangeUsername = Object(external_react_["useCallback"])(event => setUsername(event.target.value), []);
  const onChangeFirstName = Object(external_react_["useCallback"])(event => setFirstName(event.target.value), []);
  const onChangeLastName = Object(external_react_["useCallback"])(event => setLastName(event.target.value), []);
  const onChangePassword = Object(external_react_["useCallback"])(event => setPassword(event.target.value), []);
  const onChangeRepeatPassword = Object(external_react_["useCallback"])(event => setRepeatPassword(event.target.value), []);
  const toggleShowPassword = Object(external_react_["useCallback"])(() => setShowPassword(prev => !prev), []);
  const toggleShowRepeatPassword = Object(external_react_["useCallback"])(() => setShowRepeatPassword(prev => !prev), []);
  ...
  const onGoToLogIn = Object(external_react_["useCallback"])(() => router.push('/login'), [router]);
  const onSignUp = Object(external_react_["useCallback"])(async () => {
    setLoading(true);

    try {
      if (validateInputs()) {
        const res = await external_axios_default.a.post('http://localhost:3000/proxy/auth/register', {
          username,
          email,
          password,
          firstName,
        ...
        setLoading(false);
        external_js_cookie_default.a.set('token', res.data.token, {
          expires: 60 * 60
        });
        external_js_cookie_default.a.set('firstName', res.data.firstName);
        external_js_cookie_default.a.set('lastName', res.data.lastName);
        external_js_cookie_default.a.set('username', res.data.username);
        external_js_cookie_default.a.set('email', res.data.email);
        await router.push('/');
      }
  ...
  return Object(core_["jsx"])(external_react_default.a.Fragment, null, isMobile && Object(core_["jsx"])(Header, null), Object(core_["jsx"])("div", {
    ...
    alt: "authQuote",
    css: core["c" /* media */].query({
      height: ['-webkit-fill-available', '-webkit-fill-available', '-webkit-fill-available', '100vh'],
      objectFit: 'cover',
      width: '100%'
    }),
  ...
  }, Object(core_["jsx"])(components["e" /* Button */], {
    ...
    alt: "logo",
    src: "/static/images/logoWithoutIcon.svg"
  }))), Object(core_["jsx"])("div", {
  ...
  }, "\u041F\u0440\u0438\u0441\u043E\u0435\u0434\u0438\u043D\u044F\u0439\u0442\u0435\u0441\u044C \u043A \u043D\u0430\u043C!"), Object(core_["jsx"])("div", {
    ...
    color: passwordsError ? core["a" /* colors */].variants.Error.Red1 : undefined,
    helperText: passwordsError
  }, Object(core_["jsx"])(components["z" /* InputGroup */], {
    rightElement: Object(core_["jsx"])(components["e" /* Button */], {
      variant: components["h" /* ButtonVariants */].Flat,
      size: components["g" /* ButtonSizes */].ExtraSmall,
      typography: core["e" /* typography */].variants.Element.Regular12,
    ...
    onClick: onSignUp
  }, "\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044F"), Object(core_["jsx"])(components["H" /* P */], {
    className: " mb-md-0 mb-3",
    typography: core["e" /* typography */].variants.Element.Regular16
  }, "\u0423\u0436\u0435 \u0435\u0441\u0442\u044C \u0430\u043A\u043A\u0430\u0443\u043D\u0442?", ' ', Object(core_["jsx"])(components["a" /* Anchor */], {
    onClick: onGoToLogIn,
    typography: core["e" /* typography */].variants.Element.Bold16,
    color: core["a" /* colors */].variants.Text.Primary
  }, "\u0412\u043E\u0439\u0434\u0438\u0442\u0435"))))));
};
// CONCATENATED MODULE: ./src/components/pages/SignUpPage/index.ts

// CONCATENATED MODULE: ./src/pages/signup.ts
