...
module.exports = __webpack_require__("7JkC");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ ResistancePage; });
...
// CONCATENATED MODULE: ./src/components/pages/ResistancePage/graphql.ts

const queryResistancePageData = client_["gql"]`
...
`;
// CONCATENATED MODULE: ./src/components/pages/ResistancePage/component.tsx
...
const ResistancePage = props => {
  var _props$data, _props$data$data, _props$data$data$resi, _props$data2, _props$data2$data, _props$data2$data$res, _props$data3, _props$data3$data, _props$data3$data$res, _props$data4, _props$data4$data, _props$data4$data$res, _props$data5, _props$data5$data, _props$data6, _props$data6$data, _props$data7, _props$data7$data, _props$data8, _props$data8$data, _props$data8$data$res, _props$data9, _props$data9$data, _props$data9$data$res, _props$data9$data$res2, _props$data10, _props$data10$data, _props$data10$data$re, _props$data10$data$re2, _props$data10$data$re3, _props$data11, _props$data11$data, _props$data11$data$re, _props$data11$data$re2, _props$data12, _props$data12$data, _props$data12$data$re, _props$data12$data$re2, _props$data12$data$re3;

  return Object(core_["jsx"])(external_react_default.a.Fragment, null, Object(core_["jsx"])(head_default.a, null, Object(core_["jsx"])("title", null, "\u0410\u043D\u0442\u0438\u0431\u0438\u043E\u0442\u0438\u043A\u043E\u0440\u0435\u0437\u0438\u0441\u0442\u0435\u043D\u0442\u043D\u043E\u0441\u0442\u044C"), Object(core_["jsx"])("meta", {
    name: "keywords",
    content: (_props$data = props.data) === null || _props$data === void 0 ? void 0 : (_props$data$data = _props$data.data) === null || _props$data$data === void 0 ? void 0 : (_props$data$data$resi = _props$data$data.resistancePage) === null || _props$data$data$resi === void 0 ? void 0 : _props$data$data$resi.title
  }), Object(core_["jsx"])("meta", {
    name: "description",
    content: (_props$data2 = props.data) === null || _props$data2 === void 0 ? void 0 : (_props$data2$data = _props$data2.data) === null || _props$data2$data === void 0 ? void 0 : (_props$data2$data$res = _props$data2$data.resistancePage) === null || _props$data2$data$res === void 0 ? void 0 : _props$data2$data$res.title
  }), Object(core_["jsx"])("meta", {
    property: "og:title",
    content: (_props$data3 = props.data) === null || _props$data3 === void 0 ? void 0 : (_props$data3$data = _props$data3.data) === null || _props$data3$data === void 0 ? void 0 : (_props$data3$data$res = _props$data3$data.resistancePage) === null || _props$data3$data$res === void 0 ? void 0 : _props$data3$data$res.title
  }), Object(core_["jsx"])("meta", {
    property: "og:description",
    content: (_props$data4 = props.data) === null || _props$data4 === void 0 ? void 0 : (_props$data4$data = _props$data4.data) === null || _props$data4$data === void 0 ? void 0 : (_props$data4$data$res = _props$data4$data.resistancePage) === null || _props$data4$data$res === void 0 ? void 0 : _props$data4$data$res.title
  }), Object(core_["jsx"])("meta", {
    property: "og:image",
    ...
    headerButtons: (_props$data5 = props.data) === null || _props$data5 === void 0 ? void 0 : (_props$data5$data = _props$data5.data) === null || _props$data5$data === void 0 ? void 0 : _props$data5$data.headerButtons,
    footerSections: (_props$data6 = props.data) === null || _props$data6 === void 0 ? void 0 : (_props$data6$data = _props$data6.data) === null || _props$data6$data === void 0 ? void 0 : _props$data6$data.footerSections,
    headerLinks: (_props$data7 = props.data) === null || _props$data7 === void 0 ? void 0 : (_props$data7$data = _props$data7.data) === null || _props$data7$data === void 0 ? void 0 : _props$data7$data.headerLinks
  }, Object(core_["jsx"])("div", {
    className: "container my-3"
  }, Object(core_["jsx"])(components["S" /* Typography */], {
    as: "h1",
    className: "mb-4",
    css: /*#__PURE__*/Object(core_["css"])(core["e" /* typography */].styles.headingBold22, core["c" /* media */].queryStyled([core["e" /* typography */].styles.headingBold22, core["e" /* typography */].styles.headingBold28, core["e" /* typography */].styles.headingBold34]), true ? "" : undefined)
  }, (_props$data8 = props.data) === null || _props$data8 === void 0 ? void 0 : (_props$data8$data = _props$data8.data) === null || _props$data8$data === void 0 ? void 0 : (_props$data8$data$res = _props$data8$data.resistancePage) === null || _props$data8$data$res === void 0 ? void 0 : _props$data8$data$res.title), Object(core_["jsx"])(components["S" /* Typography */], {
    as: "h2",
    className: "mb-3",
  ...
  }, (_props$data9 = props.data) === null || _props$data9 === void 0 ? void 0 : (_props$data9$data = _props$data9.data) === null || _props$data9$data === void 0 ? void 0 : (_props$data9$data$res = _props$data9$data.resistancePage) === null || _props$data9$data$res === void 0 ? void 0 : (_props$data9$data$res2 = _props$data9$data$res.ResistanceArticles) === null || _props$data9$data$res2 === void 0 ? void 0 : _props$data9$data$res2.title), Object(core_["jsx"])("div", {
    className: "tw-flex tw-flex-wrap tw-justify-center"
  }, (_props$data10 = props.data) === null || _props$data10 === void 0 ? void 0 : (_props$data10$data = _props$data10.data) === null || _props$data10$data === void 0 ? void 0 : (_props$data10$data$re = _props$data10$data.resistancePage) === null || _props$data10$data$re === void 0 ? void 0 : (_props$data10$data$re2 = _props$data10$data$re.ResistanceArticles) === null || _props$data10$data$re2 === void 0 ? void 0 : (_props$data10$data$re3 = _props$data10$data$re2.articles) === null || _props$data10$data$re3 === void 0 ? void 0 : _props$data10$data$re3.map(article => {
    var _props$data$data2, _props$data$data2$res, _props$data$data2$res2;

    return article && Object(core_["jsx"])(components["A" /* InteractiveCard */], {
      key: article.id,
      description: article.description,
      title: article.title,
      buttonText: (_props$data$data2 = props.data.data) === null || _props$data$data2 === void 0 ? void 0 : (_props$data$data2$res = _props$data$data2.resistancePage) === null || _props$data$data2$res === void 0 ? void 0 : (_props$data$data2$res2 = _props$data$data2$res.ResistanceArticles) === null || _props$data$data2$res2 === void 0 ? void 0 : _props$data$data2$res2.buttonText,
    ...
    className: "mb-3",
    css: /*#__PURE__*/Object(core_["css"])(core["e" /* typography */].styles.headingBold22, core["c" /* media */].queryStyled([core["e" /* typography */].styles.headingBold22, core["e" /* typography */].styles.headingBold22, core["e" /* typography */].styles.headingBold28]), true ? "" : undefined)
  }, (_props$data11 = props.data) === null || _props$data11 === void 0 ? void 0 : (_props$data11$data = _props$data11.data) === null || _props$data11$data === void 0 ? void 0 : (_props$data11$data$re = _props$data11$data.resistancePage) === null || _props$data11$data$re === void 0 ? void 0 : (_props$data11$data$re2 = _props$data11$data$re.Videos) === null || _props$data11$data$re2 === void 0 ? void 0 : _props$data11$data$re2.title), Object(core_["jsx"])("div", {
    className: "tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4 tw-mb-10"
  }, (_props$data12 = props.data) === null || _props$data12 === void 0 ? void 0 : (_props$data12$data = _props$data12.data) === null || _props$data12$data === void 0 ? void 0 : (_props$data12$data$re = _props$data12$data.resistancePage) === null || _props$data12$data$re === void 0 ? void 0 : (_props$data12$data$re2 = _props$data12$data$re.Videos) === null || _props$data12$data$re2 === void 0 ? void 0 : (_props$data12$data$re3 = _props$data12$data$re2.YoutubeVideos) === null || _props$data12$data$re3 === void 0 ? void 0 : _props$data12$data$re3.map(videoId => videoId && Object(core_["jsx"])(external_react_youtube_default.a, {
    key: videoId.videoId,
...
// CONCATENATED MODULE: ./src/components/pages/ResistancePage/index.ts

// CONCATENATED MODULE: ./src/pages/resistance.ts
