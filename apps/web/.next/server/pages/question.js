...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ QuestionPage; });
...
// CONCATENATED MODULE: ./src/components/pages/QuestionPage/graphql.ts

const queryQuestionPage = client_["gql"]`
...
`;
// CONCATENATED MODULE: ./src/components/pages/QuestionPage/component.tsx
...
const QuestionPage = props => {
  var _data$data2, _data$data2$questionC, _data$data4, _props$data, _props$data$data, _props$data2, _props$data2$data, _props$data3, _props$data3$data, _props$data4, _props$data4$data, _props$data4$data$que, _data$data5, _data$data5$questionC, _data$data6, _data$data6$questionP, _data$data7, _data$data7$questionC, _data$data8, _data$data8$questionP;
...
QuestionPage.getInitialProps = async ctx => {
  var _ctx$query, _ctx$query2, _ctx$query2$categoryI, _ctx$req, _ctx$req$headers, _ctx$req$headers$cook, _ctx$req$headers$cook2;

  const id = (_ctx$query = ctx.query) !== null && _ctx$query !== void 0 && _ctx$query.id ? ctx.query.id.toString() : undefined;
  const categoryId = (_ctx$query2 = ctx.query) === null || _ctx$query2 === void 0 ? void 0 : (_ctx$query2$categoryI = _ctx$query2.categoryId) === null || _ctx$query2$categoryI === void 0 ? void 0 : _ctx$query2$categoryI.toString();
...
// CONCATENATED MODULE: ./src/pages/question.ts
