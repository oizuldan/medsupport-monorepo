...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"16":"0370df1baf8240dcaa2b","20":"59e0ad10814e29574e40"}[chunkId] + ".js");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ RestorePasswordPage; });
...
// CONCATENATED MODULE: ./src/components/pages/RestorePasswordPage/component.tsx
...
const RestorePasswordPage = () => {
  ...
  const onGoBack = Object(external_react_["useCallback"])(() => router.push('/login'), [router]);
  const onSendNewPassword = Object(external_react_["useCallback"])(async () => {
    setLoading(true);
    ...
    try {
      const res = await external_axios_default.a.post('http://localhost:3000/proxy/auth/restore-password', {
        email
      });
...
// CONCATENATED MODULE: ./src/components/pages/RestorePasswordPage/index.ts

// CONCATENATED MODULE: ./src/pages/restorePassword.ts
