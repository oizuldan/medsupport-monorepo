...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ SearchArticlesPage; });
...
// CONCATENATED MODULE: ./src/components/pages/SearchArticlesPage/component.tsx
...
const SearchArticlesPage = () => {
  ...
  const onChangeText = Object(external_react_["useCallback"])(event => setText(event.target.value), []);
  const onGetData = Object(external_react_["useCallback"])(async () => {
    setLoading(true);

    try {
      const res = await external_axios_default.a.get(`http://localhost:3000/proxy/api/search?query=${text}&page=${currentPage}`);
  ...
  const onPageChange = Object(external_react_["useCallback"])((_e, value) => {
  ...
  return Object(core_["jsx"])(components["B" /* Layout */], null, Object(core_["jsx"])("div", {
    ...
    loading: loading,
    size: components["g" /* ButtonSizes */].Medium,
    ...
    bordered: true
  }, "\u041F\u043E\u0438\u0441\u043A")), articles && Object(core_["jsx"])(components["C" /* List */], {
    className: "mt-4"
  }, articles.map(article => Object(core_["jsx"])(components["E" /* ListItemButton */], {
    type: "a",
    link: true,
    target: "_blank",
    href: article.link,
    key: article.title,
    typography: core["e" /* typography */].variants.Content.Regular16
  }, article.title))), loading ? Object(core_["jsx"])(components["L" /* Spinner */], {
    className: "mt-1"
  }) : totalPages && Object(core_["jsx"])(components["I" /* Pagination */], {
    count: totalPages,
    page: currentPage,
    onChange: onPageChange
  })));
};
// CONCATENATED MODULE: ./src/components/pages/SearchArticlesPage/index.ts

// CONCATENATED MODULE: ./src/pages/searchArticlesPage.ts
